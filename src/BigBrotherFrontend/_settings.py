...
@author: gpmidi
'''
# Django settings for BigBrotherFrontend project.
...
SECRET_KEY = '*qa77%$*(72^-!&o%&9*mftl$4tb0jkpxfp0zz1cfg!tq(xrwz'
...
ROOT_URLCONF = 'BigBrotherFrontend.urls'
...
#AUTH_PROFILE_MODULE = 'xxxx.UserProfile'
